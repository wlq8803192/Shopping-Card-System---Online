Public Class frmContractCityRule

    Public dvCityRule As DataView, dvRuleDetails As DataView
    Private blSkipDeal As Boolean = True, iCorrespondingRowID As Int16 = -1

    Private Sub frmContractCityRule_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me.dgvContractDetails
            .DataSource = frmContract.dtContractDetails
