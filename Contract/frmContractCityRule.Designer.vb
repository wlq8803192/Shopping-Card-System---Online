...
Partial Class frmContractCityRule
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblCityRuleChineseTitle.Text = "当前有效的城市返点规则"
        '
        'Label4
        '
        ...
        Me.Label6.Text = "黄色行是与选定的合同返点相适应的城市返点规则。"
        '
        'Label5
        '
        ...
        Me.lblExpired.Text = "备注：上面城市返点规则已过期。"
        ...
        Me.Text = "合同返点对比城市返点 Contract Discount VS City Discount"
