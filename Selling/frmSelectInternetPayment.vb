...
Public Class frmCheckInternetSales
        ...
        Try
            ...
            If ecir.CodeMsg.Code = "00" Then '查询成功
                ...
                With ecir.ExtractingCodeInfoData
                    ...
                    End Select
                    Me.txtBillBuyChannel.Text = IIf(.BillBuyChannel = "WECHAT", "微信", "支付宝") 'Wechat-微信，Alipay-支付宝
                ...
                For Each channelRow As DataRow In dtCityBillBuyChannel.Rows
                    If channelRow("BillBuyChannel").ToString = ecir.ExtractingCodeInfoData.BillBuyChannel Then
                        bBuyChannel = True
                        Exit For
                    End If
                Next
