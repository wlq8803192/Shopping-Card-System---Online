Public Class frmCardForMobile
    ...
    Private Sub frmCard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtData.Columns.Add("TelePhone", System.Type.GetType("System.String"))
    ...
    Private Sub initDataGridBinding()
        ...
        'Dim dtResult As DataTable = DB.GetDataTable("select TID,StartCardNo,replace(TelePhone,substring(TelePhone,4,5),'*****') as TelePhone,FaceValue,CardQTY from ElectronicDetails where EID in (select EID from Electronic where OrderNo = '" + sOrderNo + "' and EType = '" + sEType + "')")
        Dim dtResult As DataTable = DB.GetDataTable("select TID,StartCardNo,TelePhone,FaceValue,CardQTY from ElectronicDetails where EID in (select EID from Electronic where OrderNo = '" + sOrderNo + "' and EType = '" + sEType + "')")
        ...
        Else
            ...
            For Each drCard As DataRow In dtResult.Rows
                ...
                For iCard As Integer = 0 To iCardQTY
                    ...
                    newCard("TelePhone") = drCard("TelePhone").ToString
    ...
    Private Sub btnQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        Dim sMobile As String = txtMobile.Text.Trim, sCardNo As String = txtCardNo.Text.Trim, dtResult As DataTable, newCard As DataRow, iCard As Integer = 0

        If sMobile <> "" OrElse sCardNo <> "" Then
            dtResult = New DataTable
            dtResult.Columns.Add("CardNo", System.Type.GetType("System.String"))
            dtResult.Columns.Add("TelePhone", System.Type.GetType("System.String"))
            dtResult.Columns.Add("FaceValue", System.Type.GetType("System.Decimal"))

            Dim sFilter As String = ""
            If sCardNo = "" AndAlso sMobile <> "" Then
                'Try
                '    sMobile = sMobile.Replace(sMobile.Substring(3, 5), "*****").ToString
                'Catch
                'End Try
                sFilter = "TelePhone='" & sMobile & "'"
            ElseIf sCardNo <> "" AndAlso sMobile = "" Then
