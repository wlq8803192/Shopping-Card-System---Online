Public Class frmECancelActivationRequirement
    ...
    Private Sub frmECancelActivationRequirement_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub frmECancelActivationRequirement_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub frmECancelActivationRequirement_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                            ...
                            For Each drCard As DataRow In dtResult.Select("CardNo='" & drCUL("CardNo").ToString & "'", "SalesBillID Desc,SalesBillDetailID")
                                ...
                                If drCard("ActivationState") = 3 Then
                                    If drCUL("Balance") < drCard("FaceValue") Then
                                        ...
                                        End If
                                    Else
                                        If drCUL("CardState").ToString = "已冻结" Then
                                            newCard("CheckResult") = "不可撤销"
                                        Else
...
Submit_Again:
        ...
        If dvCard.Count > 0 Then
            ...
            Else
                If dvCard.Count > 0 Then iSucesses = ShoppingCardOperation.ElectronicFreeze(True, dvCULParameter.Table, dvCard.ToTable(True, "CardNo"))
            End If
