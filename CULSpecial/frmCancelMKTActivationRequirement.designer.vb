...
Partial Class frmCancelMKTActivationRequirement
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCancelMKTActivationRequirement))
        ...
        Me.grbQueryCardState.Text = "第二步：查询需要进行激活撤销操作的活动卡状态及其对应的销售单"
        '
        'dgvList2
        '
        ...
        Me.grbRequest.Text = "第三步：选择需要进行激活撤销操作的活动卡对应的销售单号（由此确定撤销金额）"
        '
        'chkSelectAll
        '
        ...
        Me.grbInputCardNo.Text = "第一步：输入需要进行激活撤销操作的活动卡卡号"
        '
        'dgvList1
        '
        ...
        '
        'frmCancelMKTActivationRequirement
        '
        ...
        Me.Name = "frmCancelMKTActivationRequirement"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "活动卡激活撤销申请 Cancel Marketing Card Activation Requirement"
