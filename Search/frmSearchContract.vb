Public Class frmSearchContract
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        If Me.rdbByContractCode.Checked Then
            ...
            If sContractCode.Length < 12 OrElse Not IsNumeric(sContractCode) Then
                ...
                Return
            Else
                drRows = frmContractManagement.dvContract.Table.Select("ContractCode='" & sContractCode & "'")
            End If
        Else
            drRows = frmContractManagement.dvContract.Table.Select("CustomerName Like '%" & Me.txbCustomerName.Text.Trim.Replace("'", "''") & "%'")
        End If
