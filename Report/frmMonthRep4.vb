...
Public Class frmMonthRep4
    Private fs_area_id As String, fs_area_type As String

    Private Sub frmMonthRep4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cb_query_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_query.Click
        ...
        Me.dsMonthRep4.tbRep.Rows.Clear()
        Dim i As Int32
        For i = 0 To dt.Rows.Count - 1
            Dim dr As DataRow
            dr = Me.dsMonthRep4.tbRep.NewRow
            ...
            Me.dsMonthRep4.tbRep.Rows.Add(dr)
        Next
