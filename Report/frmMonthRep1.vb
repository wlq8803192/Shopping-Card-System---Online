...
Public Class frmMonthRep1
    Private fs_area_id As String, fs_area_type As String

    Private Sub frmMonthRep1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cb_query_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_query.Click
        ...
        Me.dsMonthRep1.tbRep.Rows.Clear()
        Dim i As Int32
        For i = 0 To dt.Rows.Count - 1
            Dim dr As DataRow
            dr = Me.dsMonthRep1.tbRep.NewRow
            ...
            Me.dsMonthRep1.tbRep.Rows.Add(dr)
        Next
