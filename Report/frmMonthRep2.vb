...
Public Class frmMonthRep2
    Private fs_area_id As String, fs_area_type As String

    Private Sub frmMonthRep2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cb_query_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_query.Click
        ...
        Me.dsMonthRep2.tbRep.Rows.Clear()
        Dim i As Int32
        For i = 0 To dt.Rows.Count - 1
            Dim dr As DataRow
            dr = Me.dsMonthRep2.tbRep.NewRow
            ...
            Me.dsMonthRep2.tbRep.Rows.Add(dr)
        Next
