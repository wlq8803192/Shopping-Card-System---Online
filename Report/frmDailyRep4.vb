...
Public Class frmDailyRep4
    Private fs_area_id As String, fs_area_type As String

    Private Sub frmDailyRep4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cb_query_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_query.Click
        ...
        Me.dsDailyRep4.tbRep.Rows.Clear()
        Dim i As Int32
        For i = 0 To dt.Rows.Count - 1
            Dim dr As DataRow
            dr = Me.dsDailyRep4.tbRep.NewRow
            ...
            ls_sql_row = ls_sql_row + " and b.salesbilltype = 0 "
            ...
            Me.dsDailyRep4.tbRep.Rows.Add(dr)
        Next
